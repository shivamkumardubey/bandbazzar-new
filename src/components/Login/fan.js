    ...
    render() {
      return (
        ...
        <div class="form-container sign-up-container">
          <form action=" onSubmit={this.submitFormAdd}">
            ...
            <input  className="input "type="password" placeholder="Password"  name="password" id="password" onChange={this.onChange} value={this.state.password === null ? '' : this.state.password} placeholder="" required/>
